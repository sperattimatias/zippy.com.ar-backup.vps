...
async function bootstrap() {
  ...
  if (nodeEnv !== 'production') {
    const swaggerConfig = new DocumentBuilder().setTitle('Zippy Driver Service').setDescription('Driver onboarding KYC-lite + admin review').setVersion('1.0.0').addBearerAuth().build();
