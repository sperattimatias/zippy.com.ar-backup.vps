...
async function bootstrap() {
  ...
  if (nodeEnv !== 'production') {
    const swaggerConfig = new DocumentBuilder().setTitle('Zippy Ride Service').setDescription('Ride core + matching + OTP + realtime').setVersion('1.0.0').addBearerAuth().build();
