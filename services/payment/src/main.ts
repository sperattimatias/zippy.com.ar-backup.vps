...
async function bootstrap() {
  ...
  if (nodeEnv !== 'production') {
    const swaggerConfig = new DocumentBuilder().setTitle('Zippy Payment Service').setDescription('Payments, settlements, and financial ledgers').setVersion('1.0.0').addBearerAuth().build();
