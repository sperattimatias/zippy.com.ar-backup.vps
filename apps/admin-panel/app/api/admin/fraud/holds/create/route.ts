...
export async function POST(req: Request) {
  ...
  const res = await fetch(`${base}/api/admin/fraud/holds/create`, { method: 'POST', headers: { Authorization: `Bearer ${access}`, 'content-type': 'application/json' }, body: JSON.stringify(body) });
